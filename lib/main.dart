import 'package:bottomnavigation/auth/customer_signup.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/supplier_home': (context) => const SupplierHomeScreen(title: ''),
        '/customer_home': (context) => const CustomerHomePage(title: ''),
        '/customer_signup': (context) => const CustomerRegistor(),
      },
